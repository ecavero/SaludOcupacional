namespace SaludOcupacional_GUI
{
    partial class frmPaciente
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgPacientes.Columns.AddRange(new DataGridViewColumn[] { id_Persona, dni, apellidoPaterno, apellidoMaterno, nombre, departamento, provincia, distrito, numeroDeHistoria, estado });
